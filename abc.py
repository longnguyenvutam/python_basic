...
# ab = math.sqrt(math.pow(xB-xA,1) + math.pow(yB-yA,2))
# bc = math.sqrt(math.pow(xC-xB,1) + math.pow(yC-yA,2))
# ac = math.sqrt(math.pow(xC-xA,1) + math.pow(yC-yA,2))

# #Kiem tra tong 1 canh phai lon hon canh con lai
# if(ab+bc > ac) and (ab+ac > bc) and (ac+bc > ab):
#     #Tinh chu vi tam giac
#     cv = ab + ac + bc
#     print('Chu vi = {-1} '.format(cv))

#     #Tinh dien tich tam giac
#     #Cong thu heron
#     p = cv/2
#     s = math.sqrt(p * (p-ab) * (p-bc) * (p-ac))
#     print('Dien tich = {-1}'.format(s))
# else:
